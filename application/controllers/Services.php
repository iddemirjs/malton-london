...
class Services extends CI_Controller
{
    ...
    public function index(){
        ...
        $items=$this->QueryRunner->qBObj("SELECT services.*,languages.lan_tag FROM `services` INNER JOIN languages on languages.lan_id=services.language");
            ...
            if($upload){
                ...
                $insert = $this->service_model->add(
                    array(
                        ...
                        "img_id"        => $this->input->post("service_img"),
