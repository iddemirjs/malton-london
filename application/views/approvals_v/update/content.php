<div class="row">
    <div class="col-md-12">
        <h4 class="m-b-lg">
            <?php echo "<b>$approvals->approvals_name</b> kaydını düzenliyorsunuz"; ?>
        </h4>
    </div><!-- END column -->
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("approvals/update/$approvals->approvals_id"); ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
                        <label for="control-demo-6" class="">approvals Seçiniz</label>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="approvals Adı" name="approvals_name" value="<?php echo isset($form_error) ? set_value("approvals_name") : $approvals->approvals_name; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="approvals Url" name="approvals_url" value="<?php echo isset($form_error) ? set_value("approvals_url") : $approvals->approvals_url; ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="approvals Sıra" name="approvals_priority" value="<?php echo isset($form_error) ? set_value("approvals_priority") : $approvals->approvals_priority; ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="approvals Icon" name="approvals_icon" value="<?php echo isset($form_error) ? set_value("approvals_icon") : $approvals->approvals_icon; ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 image_upload_container">
                            <img src="<?php echo base_url("uploads/$viewFolder/$approvals->img_url"); ?>" alt="" class="img-responsive">
                        </div>
