			...
			<div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
				<div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
					<div class="gdlr-core-pbf-element">
						...
						</span>·<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Our Services." href="index.html" class="post post-page"><span property="name"><?=$language["lan_words"][59];?></span></a>
							...
							<div class="menu-services-container">
								<ul id="menu-services" class="gdlr-core-custom-menu-widget gdlr-core-menu-style-box">
									<?php foreach ($services as $key => $service): ?>
										<li class="<?=($service->url == $currentPage["url"])?'menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-5955 current_page_item menu-item-6652':'menu-item menu-item-type-post_type menu-item-object-page menu-item-6672';?>">
											<a href="<?=base_url("home/service/$service->url");?>"><?=$service->title?></a>
										</li>
									<?php endforeach ?>
								</ul>
							</div>
