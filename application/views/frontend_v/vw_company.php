			...
			<div class="gdlr-core-pbf-wrapper-content gdlr-core-js ">
				<div class="gdlr-core-pbf-wrapper-container clearfix gdlr-core-container">
					<div class="gdlr-core-pbf-element">
						...
						</span>·<span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Our Services." href="index.html" class="post post-page"><span property="name"><?=$language["lan_words"][100];?></span></a>
					...
					<div class="gdlr-core-pbf-sidebar-left gdlr-core-column-extend-left  logisco-sidebar-area gdlr-core-column-15 gdlr-core-pbf-sidebar-padding  gdlr-core-line-height" style="padding: 50px 0px 30px 0px;">
						<div class="gdlr-core-sidebar-item gdlr-core-item-pdlr">
							<div id="gdlr-core-custom-menu-widget-3" class="widget widget_gdlr-core-custom-menu-widget logisco-widget">
								<h3 class="logisco-widget-title"><?=$language["lan_words"][100];?></h3><span class="clear"></span>
								<div class="menu-services-container">
									<ul id="menu-services" class="gdlr-core-custom-menu-widget gdlr-core-menu-style-box">
										<?php foreach ($company as $key => $com): ?>
											<li class="<?=($com->url == $currentPage["url"])?'menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-5955 current_page_item menu-item-6652':'menu-item menu-item-type-post_type menu-item-object-page menu-item-6672';?>">
												<a href="<?=base_url("/home/company/".$com->url); ?>"><?=$com->title?></a>
											</li>
										<?php endforeach ?>
									</ul>
								</div>
