            ...
            <div class="widget-body">
                <form action="<?php echo base_url("menu/save"); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Menu Adı" name="menu_name" value="<?php echo isset($form_error) ? set_value("menu_name") : ""; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Menu Url" name="menu_url" value="<?php echo isset($form_error) ? set_value("menu_url") : ""; ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Menu Sıra" name="menu_priority" value="<?php echo isset($form_error) ? set_value("menu_priority") : ""; ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Menu Icon" name="menu_icon" value="<?php echo isset($form_error) ? set_value("menu_icon") : ""; ?>">
                        <?php if(isset($form_error)){ ?>
